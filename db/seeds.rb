...
user_languages = [UserLanguage.new(user: user, language:Language.first, level:5), UserLanguage.new(user: user, language:Language.last, level:3)]
user.user_languages = user_languages
